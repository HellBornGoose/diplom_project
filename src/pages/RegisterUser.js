...
const RegisterUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://ddba-78-30-214-177.ngrok-free.app/api/Auth/registration', {
        method: 'POST',
  ...
  return (
    ...
    <div className="main-content">
      <div className="login-container">
        <h1 className='h1'>Створити <br /> акаунт</h1>
        ...
        />
          ...
          <div className="input-group">
            <div className="password-wrapper">
              <img className="form-icon" src={passwordIcon} alt="password icon" />
              <input
          ...
          <div className="owner-link">
            <Link to="/registration-owner">Створити акаунт орендодавця</Link>
          </div>
        </form>
      </div>
    </div>
